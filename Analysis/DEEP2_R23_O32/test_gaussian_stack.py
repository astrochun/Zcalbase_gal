...
O2_Histograms= fitspath + 'O2_Histograms.pdf'
...
'''
#Annotations:
txt0 = r'N_Galaxies=%.3f  ynode=%.3f' % (N_Gal[ii], asc_tab['ynode'][rr]) + '\n'
            txt0 += 'R_23%.3f O_32 %.3f\n' % (asc_tab['xBar'][rr], asc_tab['yBar'][rr])  #$\overline{x}$:$\overline{y}$:
       
        
       
            ax_arr.annotate(txt0, [0.95,0.95], xycoords='axes fraction', va='top', ha='right', fontsize= '6')
'''
