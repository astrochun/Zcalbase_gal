...
def get_det3(fitspath, fitspath_ini, log=None):
    ...
    Returns calculated properties: individual_names, R23, O32, O2, O3, Hb,
    SNR2, SNR3, det3, data3
    """
    if log is None:
        log = log_stdout()
    ...
    for ii in range(1, 5):
        file1 = join(fitspath_ini,
                     f"DEEP2_Commons/Catalogs/"
                     f"DEEP2_Field{ii}_all_line_fit.fits")
    ...
    # May limit the logR23 value further to 1.2,
    # check the velocity dispersions of the high R23 spectra
    ...
    # We can create two different kinds of tables
