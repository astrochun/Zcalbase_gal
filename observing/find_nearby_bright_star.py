...
def zcalbase_gal_gemini_2018a():
    ...
    infile                  = path0 + 'targets.2018a.txt'
    out_path                = path0 + 'Alignment_Stars/'
    finding_chart_path      = path0 + 'Finding_Charts/'
    ...
    data2 = asc.read(infile, format='commented_header')
    ...
    if do_step1:
        ...
        files = [finding_chart_path+a.replace('*','')+'.SDSS.pdf' for
                 a in data2['ID']]
        #print files
        out_pdf_2018a = finding_chart_path+\
                        'GNIRS_2018A_Targets_SDSS_FindingCharts.bright.pdf'
        pdfmerge.merge(files, out_pdf_2018a)
    ...
    if do_step2:
        ...
        files = [finding_chart_path+a.replace('*','')+'_SDSS_2MASS-H.pdf' for
                 a in data2['ID']]
        out_pdf_2018a = finding_chart_path+\
                        'GNIRS_2018A_Targets_2MASS_FindingCharts.bright.pdf'
        pdfmerge.merge(files, out_pdf_2018a)
    ...
    idx2, idx1 = match_nosort_str(ID2, ID1)
    out_mag_table2 = out_path + 'Alignment_Stars.2018a.txt'
    print '### Writing : ', out_mag_table2
    asc.write(mag_table0[idx1], out_mag_table2, format='fixed_width_two_line',
              overwrite=True)
    ...
    if do_step3:
        ...
        files = [finding_chart_path+a.replace('*','')+'_SDSS_2MASS-H.PMfix.pdf' for
                 a in data2['ID']]
        out_pdf_2018a = finding_chart_path+\
                        'GNIRS_2018A_Targets_2MASS_FindingCharts.PMfix.pdf'
        pdfmerge.merge(files, out_pdf_2018a)
#enddef

def zcalbase_gal_mmt_2018b():
    '''
    Function to run find_nearby_bright_star.main() but for 2018B MMT/MMIRS
    targets
    ...
    max_radius = 120. * u.arcsec
    slitlength = 2048 * 0.201 * u.arcsec

    infile2 = path0 + 'targets.2018b.txt'
    print '### Reading : ', infile2
    data2   = asc.read(infile2, format='commented_header')
    ...
    if do_step1:
        ...
        out_pdf_2018b = finding_chart_path+\
                        'MMIRS_2018B_Targets_SDSS_FindingCharts.bright.pdf'
        pdfmerge.merge(files, out_pdf_2018b)
    ...
    if do_step2:
        ...
        files = [finding_chart_path+a.replace('*','')+'_SDSS_2MASS-H.pdf' for
                 a in data2['ID']]
        out_pdf_2018b = finding_chart_path+\
                        'MMIRS_2018B_Targets_2MASS_FindingCharts.bright.pdf'
        pdfmerge.merge(files, out_pdf_2018b)
    ...
    if do_step3:
        ...
        files = [finding_chart_path+a.replace('*','')+'.SDSS.PMfix.pdf' for
                 a in data2['ID']]
        out_pdf_2018b = finding_chart_path+\
                        'MMIRS_2018B_Targets_SDSS_FindingCharts.PMfix.pdf'
        pdfmerge.merge(files, out_pdf_2018b)
    ...
    if do_step4:
        ...
        files = [finding_chart_path+a.replace('*','')+'_2MASS_SDSS.pdf' for
                 a in data2['ID']]
        out_pdf_2018b = finding_chart_path+\
                        'MMIRS_2018B_Targets_2MASS-SDSS_FindingCharts.pdf'
        pdfmerge.merge(files, out_pdf_2018b)

#enddef

def zcalbase_gal_mmt_2019a():
    '''
    Function to run find_nearby_bright_star.main() but for 2019A MMT/MMIRS
    targets
    ...
    Notes
    -----
    Created by Chun Ly, 10 January 2019
    '''

    import pdfmerge

    # Still putting it in 2018B folder
    path0              = '/Users/cly/Dropbox/Observing/2018B/MMIRS/'
    out_path           = path0 + 'Alignment_Stars3/'
    finding_chart_path = path0 + 'Finding_Charts3/'

    epoch = 2019.0466 # Jan 18, 2019
    ...
    infile2 = path0 + 'targets.2019a.txt'
    print '### Reading : ', infile2
    data2   = asc.read(infile2, format='commented_header')
    ...
    if do_step1:
        ...
        # Merge PDF finding chart files for 2019A targets
        files = [finding_chart_path+a.replace('*','')+'.SDSS.pdf' for
                 a in data2['ID']]

        out_pdf_2019a = finding_chart_path+\
                        'MMIRS_2019A_Targets_SDSS_FindingCharts.bright.pdf'
        pdfmerge.merge(files, out_pdf_2019a)
    ...
    if do_step2:
        ...
        files = [finding_chart_path+a.replace('*','')+'_SDSS_2MASS-H.pdf' for
                 a in data2['ID']]
        out_pdf_2019a = finding_chart_path+\
                        'MMIRS_2019A_Targets_2MASS_FindingCharts.bright.pdf'
        pdfmerge.merge(files, out_pdf_2019a)
    ...
    if do_step3:
        ...
        files = [finding_chart_path+a.replace('*','')+'.SDSS.PMfix.pdf' for
                 a in data2['ID']]
        out_pdf_2019a = finding_chart_path+\
                        'MMIRS_2019A_Targets_SDSS_FindingCharts.PMfix.pdf'
        pdfmerge.merge(files, out_pdf_2019a)
    ...
    if do_step4:
        ...
        files = [finding_chart_path+a.replace('*','')+'_2MASS_SDSS.pdf' for
                 a in data2['ID']]
        out_pdf_2019a = finding_chart_path+\
                        'MMIRS_2019A_Targets_2MASS-SDSS_FindingCharts.pdf'
        pdfmerge.merge(files, out_pdf_2019a)
