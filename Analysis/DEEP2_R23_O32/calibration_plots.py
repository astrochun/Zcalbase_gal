...
def LAC_GPC_plots(fitspath, dataset,revised= False, individual = False, include_Rlimit = True):
    ...
    # green_peas_calibration.main(lR23,lO32, OH, pea_out_pdf1, n_bins=6, xra=[0.3,1.15],
                                # yra=[6.5,9.10], marker=['D', '3', '4'], edgecolors=['face', 'face', 'none'],
                                # label=['Detection', 'DEEP2', 'MACT'], fit=False, silent=False, verbose=True)
